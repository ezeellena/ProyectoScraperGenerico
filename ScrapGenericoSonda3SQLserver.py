        ...
        try:
            for Portal in Portales:
                ...
                try:
                    ...
                    sql = "SELECT tag FROM portales_tag where portales = "+"'"+ Portal["url"]+"'" + ""
...
def InsertNoticiaMySql(data):
    try:
        ...
        print(valores)
        print(valores[6])
        print(type(valores[6]))
        conn.conexion.commit()
        print(str(valores[0])+" fue agregado a la base de datos con exito")
    except Exception as error:
        print(error)
        print(str(valores[0])+" no se agrego por duplicado")